...
// ---- extension pages ----
// Pages the extension opens itself (not named in the manifest)
const OWN_PAGES = ['reader.html'];
for (const page of [manifest.side_panel?.default_path, manifest.options_page, ...(manifest.sandbox?.pages || []), ...OWN_PAGES].filter(Boolean)) {
